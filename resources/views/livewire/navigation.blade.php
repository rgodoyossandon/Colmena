<header class="bg-trueGray-200 sticky top-0" style="z-index: 900" x-data="dropdown()">
    <div class="container flex items-center h-16 justify-between md:justify-start">
        <a  :class="{'bg-opacity-100 text-yellow-600' : open}"
            x-on:click="show()"
            class="flex flex-col items-center justify-center order-last md:order-first px-6 md:px-4 bg-truegray-200 bg-opacity-25 text-black cursor-pointer font-semibold h-full">
        ...
        <div class="mx-6 relative hidden md:block">
            @auth
                ...
                <x-jet-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <!-- Account Management -->
                        <div class="block px-4 py-2 text-xs text-amber-400">
                            {{ __('Manage Account') }}
                        </div>
    ...
    <nav id="navigation-menu"
        ...
        class="bg-trueGray-200 bg-opacity-25 w-full absolute hidden">
            ...
            <div
                ...
                <ul class="bg-white">
                    @foreach ($categories as $category)
                        <li class="navigation-link text-trueGray-500 hover:bg-amber-300 hover:text-white">
        ...
        <div class="bg-white h-full overflow-y-auto">
            ...
            <ul>
                @foreach ($categories as $category)
                    <li class="text-trueGray-500 hover:bg-amber-300 hover:text-white">
                        <a href="{{route('categories.show', $category)}}" class="py-2 px-4 text-sm flex items-center">
